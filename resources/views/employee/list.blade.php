                    ...
                    <tr valign="middle">
                        ...
                        <td>
                            @if($employee->image != '' && file_exists(public_path().'/uploads/employees/'.$employee->image))
                                <img src="{{url('uploads/employees/'.$employee->image)}}" alt="" width="40px" height="40px" class="rounded-circle">
                            @else
                            <img src="{{url('assets/images/no-image.png.png')}}" alt="" width="40px" height="40px" class="rounded-circle">
                            @endif
                        </td>
                        <td>{{$employee->name}}</td>
